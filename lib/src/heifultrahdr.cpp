...
uhdr_error_info_t heif_get_gainmap_metadata(struct heif_image_handle* base_handle,
...
HeifUltraHdr::HeifUltraHdr(void* uhdrGLESCtxt, int mapDimensionScaleFactor, int mapCompressQuality,
...
/* Decode API */
uhdr_error_info_t HeifUltraHdr::decodeHeicUltraHdr(uhdr_compressed_image_t* uhdr_compressed_img,
