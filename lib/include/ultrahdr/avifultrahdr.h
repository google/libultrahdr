...
#ifndef ULTRAHDR_AVIFULTRAHDR_H
#define ULTRAHDR_AVIFULTRAHDR_H
...
extern uhdr_error_info_t heif_get_gainmap_metadata(struct heif_image_handle* base_handle,
                                                   uhdr_gainmap_metadata_ext_t* metadata);

class AvifUltraHdr : public UltraHdr {
 public:
  AvifUltraHdr(void* uhdrGLESCtxt = nullptr,
   ...
   *         ----------------------------------------------------------------------
   */
  uhdr_error_info_t decodeAvifUltraHdr(uhdr_compressed_image_t* uhdr_compressed_img,
