...
typedef struct ultrahdr_uncompressed_struct   jpegr_uncompressed_struct;
typedef struct ultrahdr_compressed_struct     jpegr_compressed_struct;
typedef struct ultrahdr_exif_struct           jpegr_exif_struct;

typedef struct ultrahdr_uncompressed_struct* jr_uncompressed_ptr;
typedef struct ultrahdr_compressed_struct* jr_compressed_ptr;
typedef struct ultrahdr_exif_struct* jr_exif_ptr;
