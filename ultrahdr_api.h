 ...
 * content, there is no default value, needs configuration, otherwise, error is thrown during
 ...
 * - If the application wants to set nominal peak brightness
 ...
 * - If the application wants to set min max content boost
